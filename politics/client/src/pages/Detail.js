      ...
      <div>
        ...
        <Container>
          <Card className="black white-text center">
            <h3>
              {this.state.member.constituency} constituency is represented by{" "}
        ...
        <Row>
          ...
          <Col m={6} s={12}>
            <Card
              ...
              header={
                <CardTitle image={this.state.member.imageHref}></CardTitle>
              }
            ></Card>
          </Col>
          ...
          <Col className="l6">
            <Card className="black white-text">
              <h1>Bio</h1>
              <h5>{this.state.member.bio}</h5>
            </Card>
          </Col>

          <Col className="l6"></Col>
